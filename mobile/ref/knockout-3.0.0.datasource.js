        ...
        (function(factory) {
                        ...
                        try {
                            ...
                            for (var a = this._subscriptions[event].slice(0), i = 0, subscription; subscription = a[i]; ++i) {
                                ...
                                if (subscription && (subscription.isDisposed !== true))
                                    subscription.callback(valueToNotify, subscription.context);
                            }
                        } finally {
            ...
            ko.dependentObservable = function(evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
                ...
                function addSubscriptionToDependency (subscribable) {
                    var subscription = subscribable.subscribe(evaluatePossiblyAsync);
                    subscription['context'] = {node: options.bindingNode};
                ...
                function evaluatePossiblyAsync (valueToNotify, evaluateFunctionContext) {
                    var throttleEvaluationTimeout = dependentObservable['throttleEvaluation'];
                    if (throttleEvaluationTimeout && throttleEvaluationTimeout >= 0) {
                        clearTimeout(evaluationTimeoutInstance);
                        evaluationTimeoutInstance = setTimeout(function() {
                            evaluateImmediate(evaluateFunctionContext);
                        }, throttleEvaluationTimeout);
                    } else
                        evaluateImmediate(evaluateFunctionContext);
                }

                function evaluateImmediate (evaluateFunctionContext) {
                    ...
                    try {
                        ...
                        var newValue = evaluatorFunctionTarget ? readFunction.call(evaluatorFunctionTarget, evaluateFunctionContext) : readFunction(evaluateFunctionContext);
                ...
                function dependentObservable () {
                    if (arguments.length > 0) {
                        ...
                        if (!_hasBeenEvaluated)
                            evaluateImmediate({node: options.bindingNode});
            ...
            (function() {
                ...
                ko.bindingContext.prototype['createChildContext'] = function(dataItemOrAccessor, dataItemAlias, extendCallback) {
                    return new ko.bindingContext(dataItemOrAccessor, this,
                        dataItemAlias || ko.bindingContext['extension'].getItemAlias(dataItemOrAccessor),
                        function(self, parentContext) {
                            ...
                            extendCallback = extendCallback || ko.bindingContext['extension'].makeExtendCallback(dataItemOrAccessor);
                            if (extendCallback)
                                extendCallback(self);
                        });
                };
                ...
                ko.bindingContext['extension'] = {
                    getItemAlias: function(dataItemOrAccessor) {
                        return null;
                    },

                    makeExtendCallback: function(dataItemOrAccessor) {
                        return null;
                    }
                };
                ...
                function applyBindingsToNodeAndDescendantsInternal (bindingContext, nodeVerified, bindingContextMayDifferFromDomParentElement) {
                    ...
                    if (bindingContext['shouldApplyBindingsCallback']) {
                        shouldApplyBindings = shouldApplyBindings && bindingContext['shouldApplyBindingsCallback'](bindingContext, nodeVerified, bindingContextMayDifferFromDomParentElement);
                    }
...
//                        ko.storedBindingContextForNode(node, bindingContext);
                            ...
                            try {
                                ...
                                if (typeof handlerUpdateFn == "function") {
                                    ko.dependentObservable(
                                        function(evaluateFunctionContext) {
                                            handlerUpdateFn(evaluateFunctionContext.node, getValueAccessor(bindingKey), allBindings, bindingContext['$data'], bindingContext);
                                        },
                                        null,
                                        { disposeWhenNodeIsRemoved: node, bindingNode: node }
                                    );
                                }
                            } catch (ex) {
                ...
                function getBindingContext (viewModelOrBindingContext) {
                    return viewModelOrBindingContext && (viewModelOrBindingContext instanceof ko.bindingContext)
                        ...
                        : new ko.bindingContext(viewModelOrBindingContext, null,
                        ko.bindingContext['extension'].getItemAlias(viewModelOrBindingContext),
                        ko.bindingContext['extension'].makeExtendCallback(viewModelOrBindingContext));
                }
